...
from .exp_bank import Experience, ExperienceBank, get_experience_bank
from ..prompts import render_system_prompt
from ..utils import init_env_client, _get_outcome_reward
...
async def generate(args: Any, sample: Sample, sampling_params: dict, evaluation: bool = False) -> Sample | List[Sample]:
    ...
    experience_bank = get_experience_bank(config)
    ...
    *,
    ...
    while True:
        ...
        if parsed.type is None:
            ...
            obs, done, sub_sample, sub_turn = await run_subagent(
                args=args,
...
async def run_subagent(
    ...
    *,
    ...
    return feedback, False, finalized, 1
