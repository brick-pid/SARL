...
source "${REPO_DIR}/scripts/models/qwen3-4B-Instruct-2507.sh"

CKPT_ARGS=(
   --hf-checkpoint "${REPO_DIR}/models/qwen3-4b-inst-2507" # 加载 config/tokenizer/etc.
...
ROLLOUT_ARGS=(
   --prompt-data "${REPO_DIR}/data/agentgym/train/${ENV}_train.jsonl"
   --input-key task_id
